...
//import library for print formatting for dollar values and decimals
...
public class bankSystem {
    ...
    static class Bank {
        private final BankAccount[] accounts; // all the bank accounts at this bank
...
// available at the bank, it should print a message.
    ...
    static class BankAccount{
        ...
        private final String[] transactionsSummary;
        ...
        {
            if (amount <= 0){
                System.out.println("Amount to be withdrawn needs to be positive");
            }
            else
            {
                if (balance < amount) {
